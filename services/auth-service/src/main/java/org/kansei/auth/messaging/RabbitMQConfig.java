...
public class RabbitMQConfig {
    ...
    // Consumed by the courier-one service - not declared here as a queue since auth-service only publishes. The exchange is declared on both sides so either can start first.
